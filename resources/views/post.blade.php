...
<head>
    ...
    <title>The TechGuy Blog [TG]</title>
    <!-- Bootstrap core CSS -->
    ...
    <div class="row">
        ...
        <div class="col-md-2 col-xs-12">
            <div class="share">
                ...
                <ul>
                    <li>
                        <a target="_blank" href="https://twitter.com/winstonwacieni">
                    ...
                    <li>
                        <a target="_blank" href="https://www.facebook.com/winstonwacieni">
        ...
        <div class="col-md-8 col-md-offset-2 col-xs-12">
            <div class="mainheading">
                ...
                <h1 class="posttitle">The Psychology of Colors in Design: Unraveling the Impact of Hues on Our Emotions</h1>

            </div>

            <!-- Begin Featured Image -->
            <img class="featured-image img-fluid" src="assets/img/demopic/colors.jpg" alt="Colors and Hues">
            <!-- End Featured Image -->

            <!-- Begin Post Content -->
            <div class="article-post">
                <p>
                    Colors have a profound impact on our emotions and perceptions, often influencing our thoughts and behaviors without us even realizing it. The study of color psychology delves into the fascinating connections between colors and the human psyche. In this article, we explore the psychological effects of various hues and how they can evoke specific emotions and shape our experiences in everyday life.
                </p>
                <p>
                    The Language of Colors:
                    Colors speak a universal language that transcends cultural and linguistic barriers. Discover how red, blue, green, and other shades communicate different messages, triggering a spectrum of emotions ranging from passion and tranquility to envy and optimism.
                </p>
                <p>
                    The Calm Serenity of Blue:
                    Blue, the color of the vast sky and serene oceans, is known for its calming and tranquil effects. Uncover how this cool hue can alleviate stress, promote relaxation, and boost productivity, making it a popular choice in various environments, from bedrooms to workspaces.
                </p>
                <blockquote>
                    The Fiery Allure of Red:
                    Bold and attention-grabbing, red stimulates passion, energy, and excitement. Explore how this fiery hue can evoke strong emotions, incite action, and even increase appetite, making it a popular choice in marketing and design.
                </blockquote>
                <p>
                    The Balance of Green:
                    Green, representing nature and growth, instills a sense of harmony and balance. Learn how this refreshing color can evoke feelings of renewal, prosperity, and environmental consciousness, making it prevalent in eco-friendly branding and healthcare settings.
                </p>
            </div>
            <!-- End Post Content -->
    ...
    <div class="container">
        <div class="row listrecent listrelated">
            ...
            <div class="col-md-4">
                <div class="card">
                    <a href="post.html">
                        <img class="img-fluid img-thumb" src="assets/img/demopic/uganda.png" alt="">
                    </a>
                    <div class="card-block">
...
<div class="alertbar">
    <div class="container text-center">
        <img src="assets/img/favicon.svg" alt="logo" height="24px" width="24px"> &nbsp; Never miss a <b>story</b> from us, get weekly updates in your inbox. <a href="https://twitter.com/winstonwacieni" class="btn subscribe">Get Updates</a>
    </div>
</div>
<!-- End AlertBar
================================================== -->
